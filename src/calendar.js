const { getCalorieGrade } = importModule("getCalorieGrade");
...
var settings = {
  ...
  D: "#1F432B",
  F: "#171B21",
  bookmark: "Auto Export",
  goalPoundsPerWeek: 1.7,
  debug: true,
  calendarApp: "calshow",
...
function createDateImage(
  ...
  drawing.setFillColor(new Color(actualPercent));
  drawing.fillEllipse(
    new Rect(
